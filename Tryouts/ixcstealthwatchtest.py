...
SMC_HOST="10.113.108.55"
API_ENDPOINT = "https://10.113.108.55/smc"
API_HEADER = {"Content-Type": "application/json;charset=UTF-8", \
              "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.12; rv:51.0) Gecko/20100101 Firefox/51.0", \
              "Referer": "https://10.113.108.55/lc-landing-page/", "Cookie":""} #, "Cookie": "JSESSIONID=475C7C3E5C29260C1E6AF431478D41D1; JSESSIONID=416C3BC0B4754464F322248B480F0D13"}
...
def login_via_web( user, pwd):
    ...
    resp = req.post( url=_url, headers={"Content-Type": "application/x-www-form-urlencoded", \
                                "Referer": "https://10.113.108.55/lc-landing-page/", \
                                "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.12; rv:51.0) Gecko/20100101 Firefox/51.0",\
                                "Origin": "https://10.113.108.55"}, \
...
if __name__ == '__main__':
    cookie = login_via_web('MEAIXC', 'Cisc0123')
