...
## http://docs.activestate.com/activepython/3.3/pywin32/Windows_NT_Eventlog.html
...
servers = ['web03', 'web03balvm', 'web04', 'web04balvm']
# servers = ['web03balvm']
...
with open(html_output_file, "w") as out:
    ## the string is machine dependent. For Windows: https://msdn.microsoft.com/en-us/library/39cwe7zf(vs.71).aspx
